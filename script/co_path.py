...
def pathPlotting(ob_num_max, safety_dist, robot_r, targets ,results_rootpath):
    ...
    save_path = results_rootpath + '/co_path.png'
...
if __name__ == "__main__":
   ...
   results_rootpath = './co_path_result' 
   pathPlotting(3, 0.3, 0.6, [12.0, 12.0] ,results_rootpath)